...
import 'package:flutter_work/Model/Expense.dart';
...
class _ExpenseTrackerState extends State<ExpenseTracker> {
  ...
  void _showForm(BuildContext context) {
    ...
    String selectCategory = _category.first;
                ...
                SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          ...
                          _addExpense(titleController.text, double.parse(amountController.text), selectedDate, selectCategory);
                  ...
                  return Dismissible(
                    ...
                    child: Card(
                      child: ListTile(
                        ...
                        trailing: Text(_expense[index].amount.toString(),style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                      ),
                    ),
                  );
                }),
